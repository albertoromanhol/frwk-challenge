...
class MainActivity : AppCompatActivity() {
    ...
    private fun populateDatabase() {
        ...
        callbackPosts.enqueue(object : Callback<List<PostEntity>> {
        ...
        callbackAlbums.enqueue(object : Callback<List<AlbumEntity>> {
        ...
        callbackTodos.enqueue(object : Callback<List<TodoEntity>> {
